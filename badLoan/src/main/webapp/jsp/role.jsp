	...
	<div id="handlerDialog">
		<form id="myForm" method="post">
			<table width="100%" class="formtable">
				<tr>
					<th height="25" >角色编号：</th><td><input id="proId" name="roleId"></td>
				</tr>
				<tr>
					<th height="25" >角色姓名：</th><td><input id="proName" name="roleName"></td>
				</tr>
				<tr>
					<th height="25" >角色说明：</th><td><input id="proPrice" name="roleComment"></td>
				</tr>			
			</table>
		</form>
	</div>
