...
datagrid=$('#dg').datagrid({    
    ...
    fitColumns: true,
    columns:[[    
        {field:'empId',title:'员工编号',width:200},    
     	{field:'empName',title:'员工姓名',width:100},
     	{field:'empTelphone',title:'员工电话',width:100,},
     	{field:'empEmail',title:'员工邮箱',width:100}
    ]],
    toolbar:[
    	{
    	text:'添加',
...
function searchByCondition(){
		datagrid.datagrid('load',{ename:$("#ename").val(),job:$("#job").val()}
