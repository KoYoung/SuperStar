...
public class WriteoffManage {
	...
	public String toString() {
		return "WriteoffManage [lmrComment=" + lmrComment + ", contractId=" + contractId + ", reapMoney=" + reapMoney
				+ ", lmrName=" + lmrName + ", writeoffId=" + writeoffId + ", loaninfoId=" + loaninfoId + ", borId="
				+ borId + ", empId=" + empId + ", witeoffMoney=" + witeoffMoney + ", opinion=" + opinion + ", borName="
